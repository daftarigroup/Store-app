...
export default () => {
    ...
    const columns: ColumnDef<RecieveItemsData>[] = [
        ...
        {
            accessorKey: 'challanImage',
            header: 'Challan Image',
            cell: ({ row }) => {
                const photo = row.original.challanImage;
                return photo ? (
                    <a href={photo} target="_blank" className="text-primary hover:underline font-medium">
                        View Challan
                    </a>
