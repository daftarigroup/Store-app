                ...
                <Tabs defaultValue="pending">
                    ...
                    <TabsContent value="pending">
                        <DataTable
                            data={tableData}
                            columns={columns}
                            searchFields={['product', 'indenter', 'firmNameMatch']}
                    ...
                    <DialogContent className="w-[95vw] md:max-w-3xl">
                        <Form {...form}>
                            ...
                            >
                                ...
                                {/* Indent Info Summary */}
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-4 rounded-md border text-sm bg-muted/20">
                                    <div>
                                ...
                                <div className="rounded-md border overflow-y-auto text-sm max-h-[400px]">
                                    <FormField
                                                    ...
                                                    >
                                                        <table className="w-full text-left">
                                                            <thead className="bg-muted sticky top-0 z-10">
                                                                <tr>
                                                                    <th className="px-4 py-3 font-medium w-12 text-center bg-muted">Select</th>
                                                                    <th className="px-4 py-3 font-medium bg-muted">Vendor</th>
                                                                    <th className="px-4 py-3 font-medium text-center bg-muted">Tech Rank</th>
                                                                    <th className="px-4 py-3 font-medium text-right bg-muted">Effective Rate</th>
                                                                </tr>
                                                            </thead>
